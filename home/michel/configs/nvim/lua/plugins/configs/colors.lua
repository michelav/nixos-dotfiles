-- Extracted from https://github.com/EdenEast/nyx
...
function M.generate_user_config_highlights()
  ...
  for name, value in pairs(sl_colors) do
    colors["SL" .. name] = { fg = value.fg, bg = value.bg, style = "bold" }
    colors["SLRv" .. name] = { fg = value.bg, bg = value.fg, style = "bold" }
  end
...
--     function()
--       require("plugins.configs.colors").generate_user_config_highlights()
--     end,
--   },
-- }
