...
, Cocoa, Foundation, System, libiconv, UserNotifications, nixosTests, runCommand
, vulkan-loader }:
...
rustPlatform.buildRustPackage rec {
  ...
  src = fetchFromGitHub {
    ...
    hash = "sha256-y6HqUeHf/xXBkc5S4CcXlBIdTnbNOxoioPAuOlSnuBw=";
  };
  ...
  cargoLock = {
    lockFile = ./Cargo.lock;
    outputHashes = {
      # "image-0.24.7" = "sha256-fTajVwm88OInqCPZerWcSAm1ga46ansQ3EzAmbT58Js=";
